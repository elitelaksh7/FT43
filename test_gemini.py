...
def test_gemini_categorization():
    """Test Gemini AI categorization with various merchants"""
    ...
    print("\n🧪 Testing Gemini AI Categorization:")
    print("=" * 50)
...
{{"category": "Category_Name", "confidence": 0.95, "reasoning": "Brief explanation"}}"""
            ...
            print(f"🏪 {merchant:25} → {result['category']:12} ({result.get('confidence', 0):.2f}) - {result.get('reasoning', 'No reason')}")
